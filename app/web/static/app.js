...
const lmstudioLocalModelsList = document.getElementById("lmstudio-local-models-list");

async function loadLocalLMStudioModels() {
  try {
...
function openStatusModal() {
  ...
  loadDependencies();
  lmstudioModelPicker.load();
  whisperModelPicker.load();
  loadLocalLMStudioModels();
